...
#define SRC_M7MIX_SLICE_SW_CTRL   (0x44463420UL)
#define SRC_M7MIX_SLICE_FUNC_STAT (0x444634b4UL)
#define SRC_M7MIX_SLICE_MEM_CTRL  (0x44463504UL)
#define SRC_M7MIX_SLICE_MEM_STAT  (0x44463518UL)
